...
def settings_click():
    ...
    if settings == settings_click:
        ...
        def save_settings_click():
            ...
            if SelectedColor == "":
                ...
                if SelectedColor in COLORS:
                    win.configure(background=SelectedColor)
                else:
                    en_color.delete(0, 'end')
                    en_color.insert(0, "Pleas enter a valid color")
        ...
        def color_scheme():
            ...
            top = Toplevel()
            top.title("All available colors")
            row = 0
            col = 0
            for color in COLORS:
                e = Label(top, text=color, background=color,
                          font=(None, -FONT_SIZE))
        ...
        b_color = Button(win, text="AVAILABLE COLORS", command=color_scheme)
        b_color.place(x=285, y=240)
        ...
        # SETTINGS ENTRY
        en_color = Entry(win, text="", width=25)
        en_color.place(x=264, y=220)
